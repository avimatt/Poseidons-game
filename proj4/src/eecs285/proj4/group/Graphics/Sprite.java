...
public class Sprite extends BufferedImage{
  ...
  public static Sprite TWOTILEGRAVEYARD = new Sprite(32, 16, new Location(2, 3), ImageLoader.spriteSheet);
  public static Sprite THREETILEGRAVEYARD = new Sprite(48, 16, new Location(6, 3), ImageLoader.spriteSheet);
